...
function TaskCreate() {
  ...
  const onFinish = (values) => {
    ...
    // Di sini nanti Anda akan mengirim data ke backend (API)
  };

  return (
    <div style={{ // Ini adalah container utama untuk memusatkan card di tengah halaman
      display: 'flex',
      ...
      <div style={{ // Menggantikan .task-form-card
        ...
        <p style={{ gridColumn: '1 / 2', color: '#666', marginBottom: '25px', marginLeft: '50px' }}>Add New Task!</p>
        ...
        <div style={{ // Menggantikan .image-placeholder
          ...
          <img src={stickmanImage} alt="Todo List Illustration" style={{ // Menggantikan .image-placeholder img
            maxWidth: '100%',
            height: 'auto',
            display: 'block',
          }} />
